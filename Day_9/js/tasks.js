...
const multiline2 = `The ${item} costs ₹${price} + ₹${(price*tax).toFixed(2)} GST = ₹${(price*(1+tax)).toFixed(2)}.`;
...
const user = { name1: "Anaya", age: 21, address: { city: "Jaipur", pincode: "302001" } };
const {name1, age:userAge, address:{city}} = user;
